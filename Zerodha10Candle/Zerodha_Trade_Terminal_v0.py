...
def start_excel():
    ...
    tt.range(f"a2:t2").value = [ "Symbol", "Open", "High", "Low", "Close", "VWAP", "Best Buy Price",
    ...
    while True:
        ...
        try:
            ...
            #print(live_data)
            symbols = tt.range(f"a{3}:a{1000}").value
            trading_info = tt.range(f"l{3}:t{1000}").value
            ...
            for i in symbols:
                ...
                cand_lst= [None for _ in range(46)]
            ...
            tt.range("b3:k1000").value = main_list
           
            
            
            if (newdata):
                load_6Candle = False
                tt.range("v3:bo1000").value = candle_list                
                newdata=False
